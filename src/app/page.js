  ...
  <a href="#clients" className="flex items-center justify-center px-4 py-2 mt-4 text-base font-bold text-white transition bg-indigo-500 rounded-full hover:bg-indigo-600 md:px-6 md:py-3 md:mt-6 md:text-lg">
    View Our Clients
        ...
        <div className="mt-8 md:mt-0">
          <img
            src="https://www.raviearthing.com/wp-content/uploads/2020/02/Ravi-Earthing-Logo-1.png" // Replace with your custom illustration
            alt="Illustration"
            className="h-96"
          />
        </div>
      ...
      <section className="py-20 text-center bg-gray-100" id="services">
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto md:grid-cols-3 max-w-7xl">
          <div className="p-8 bg-white rounded-lg shadow-lg">
            <img src="https://i.ytimg.com/vi/PgQnT94pd8I/maxresdefault.jpg" alt="Installation" className="object-cover w-full h-40 mb-4 rounded" />
          ...
          <div className="p-8 bg-white rounded-lg shadow-lg">
            <img src="https://eshop.se.com/in/media/shoptimize/blog/post/b/l/blog-2.jpg" alt="Maintenance" className="object-cover w-full h-40 mb-4 rounded" />
          ...
          <div className="p-8 bg-white rounded-lg shadow-lg">
            <img src="https://www.iczgroup.com/wp-content/uploads/2017/09/Log_01_1.jpg" alt="Custom Solutions" className="object-cover w-full h-40 mb-4 rounded" />
